...
import {LetterOfCreditViewPage} from "../view/letter-of-credit-view.page";

@Component({
  selector: "letter-of-credit-listing",
  templateUrl: "./letter-of-credit-listing.page.html",
  styleUrls: ["./letter-of-credit-listing.page.scss"],
  providers: [TranslatePipe]
})
export class LetterOfCreditListingPage implements OnDestroy, BaseTransaction {
  ...
  checkForCurrenctEntity() {
    return this.listingService.selectedTab.entityName === "LETTEROFCREDIT";
  }
  ...
  viewTransactionCommonService(item, $event: MouseEvent) {
    if (this.multiSelectionMode) {
      ...
      this.router.navigate(["/menu/import-trade/view/letterofcredit", item.id]);
    }
  ...
  view(item, $event: MouseEvent): void {
    if (this.multiSelectionMode) {
      ...
      this.transactionService.viewInModal(item.id, LetterOfCreditViewPage);
      // this.router.navigate(["menu", "import-trade", "view", "letterofcredit", item.id]);
    }
  }
